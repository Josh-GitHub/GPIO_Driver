...
/*
 * base-Adress of AHBx and APBx bus
 */
...
/*
 * base adress of reset and clock control module (RCC)
 */
...
/*
 * struct with configuration and data-register of GPIO-ports
 */
typedef struct
{
  ...
  volatile uint32_t BIT_SET_RESET_REG;			/* Address offest: 0x18 */
  volatile uint32_t CONF_LOCK_REG;				/* Address offest: 0x1C */
  volatile uint32_t ALT_FUNC_LOW_REG;			/* Address offset: 0x20 */
  volatile uint32_t ALT_FUNC_HIGH_REG;			/* Address offset: 0x24 */
}GPIO_RegDef_t;

/*
 * configurationregister of RCC
 */
typedef struct
{
...
/*
 * baseadress getting caseted on specific structs
 */
...
/*
 * Clock enable and disable macros for specific GPIO-Ports
 */
 ...
 * Only contains IRQ-Numbers for EXTI
 */
...
typedef struct
{
	...
	uint32_t      RESERVED2[2];   	//Reserved, 		0x24-0x28 GPI
